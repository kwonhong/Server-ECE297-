...
{
	printf("test_setcomplex_deletethreecols\n");
	// Delete a key/value pair.
...
START_TEST (test_setcomplex_updatethreecols) {
	...
	printf("test_setcomplex_updatethreecols\n");
	struct storage_record record;
	memset(&record, 0, sizeof record);
        int fields = 0;
	int intval = 0;
...
{
        printf("test_concurrency_setget\n");
        struct storage_record record;
        memset(&record, 0, sizeof record);
        int status = 0;
        int fields = 0;
...
{
        printf("test_concurrency_txpass\n");
        struct storage_record record;
        memset(&record, 0, sizeof record);
        int fields = 0;
        int intval = 0;
